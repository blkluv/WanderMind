                ...
                {Object.entries(nearbyPlaces[selectedDay]).map(([placeName, gems]) => (
                  gems.length > 0 && (
                    <div key={placeName} className="space-y-2">
                      ...
                      {gems.map((gem, idx) => (
                        <div key={idx} className="p-2 border border-yellow-200 rounded bg-yellow-50 dark:bg-yellow-900/20 dark:border-yellow-800">
        ...
        <CardContent className="pt-4">
          <div className="flex items-start gap-2">
            ...
            <div className="text-sm text-blue-800 dark:text-blue-200">
              <p className="mb-1 font-semibold">Smart Maps Features:</p>
